...
def get_summarization(article=""):
    ...
    # summarizer = pipeline("summarization", model="fb-bart-large-cnn")     # use this for local runtime
    summarizer = pipeline("summarization", model="/opt/bart-large-cnn")     # use this for k8s
